...
class ExtractJob:
    ...
    Attributes:
        job_id: The ID of the extract job
    """
...
@dataclass
class ExtractResult:
    """Result from an extract job.

    Attributes:
        status: Current status of the job ('queued', 'active', 'completed', 'failed')
        error: Error information if the job failed
        data: Extracted data from the video
        schema: JSON Schema generated by AI (only present when no schema was provided in the request)
    """
